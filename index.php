    ...
    <div class="container site">
        ...
        <nav>
            <ul class="nav nav-pills">
                <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab"  href="#p1">menu</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#p2">Burgers</a>
                </li>
                <li class="nav-item">
        ...
        <div class="tab-content">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
            ...
            <div class="tab-pane" id="p4">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/sa1.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/sa2.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/sa3.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
            ...
            <div class="tab-pane" id="p5">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/bo1.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/bo3.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price" class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
                                <a href="#" type="button"class="btn_commande"><span class="fas fa-cart-plus"></span>Commander</a>
                            </div>
            ...
            <div class="tab-pane" id="p6">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/d1.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/d2.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card">
                            <img src="images/d3.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="price">8.90€</p>  
                                <h5 class="card-title">Menu Classic</h5>
                                <p class="card-text">Sandwich: Burger, Salade, Tomate, Cornichon + Frites + Boisson</p>
