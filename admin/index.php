    ...
    <body>
            ...
            <div class="container admin">
                <div class="row table-responsive">
                    <h2><strong>Liste des Items :</strong><a href="insert.php" type="button"class="btn btn-success btn-sm ml-3"><span class="fas fa-plus"></span> Ajouter</a><a href="../index.php" type="button"class="btn btn-primary btn-sm ml-3"><span class="fas fa-arrow-left"></span> retour </a></h2>
